...
JAZZMIN_SETTINGS  = {
    "site_title": "GREEN API ACADEMY Admin",
    "site_header": "GREEN API ACADEMY",
    "site_brand": "GREEN API ACADEMY",
    # "site_logo": "path-to-logo",
    "welcome_sign": "Welcome to the Green API Academy",
    "copyright": "Green API Academy Ltd",
...
SWAGGER_SETTINGS = {
    ...
    'VALIDATOR_URL': None,
    'SCHEMES': ['http', 'https'],  # This defines both HTTP and HTTPS schemes
}
