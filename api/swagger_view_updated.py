...
def redoc_ui_view(request: HttpRequest) -> HttpResponse:
    ...
    swagger_spec = {
        ...
        "paths": {
            ...
            # User endpoints (simplified for ReDoc)
            "/users/": {
                "get": {
                    "tags": ["Users"],
                    "summary": "List users",
            ...
            # Course endpoints (simplified for ReDoc)
            "/courses/": {
                "get": {
                    "tags": ["Courses"],
        ...
        "components": {
            ...
            "schemas": {
                # Basic schemas (simplified for ReDoc)
                "User": {
                    "type": "object",
                    "properties": {
                        "id": {
